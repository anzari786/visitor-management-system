...
const inputVariants = cva(
   'text-foreground placeholder:text-muted-foreground [[readonly]]:bg-muted/80 border-input focus-visible:border-ring aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive dark:bg-input/30 focus-visible:ring-ring/50 flex w-full rounded-md border bg-transparent text-sm shadow-xs transition-[color,box-shadow] outline-none focus-visible:ring-[3px] disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:ring-[3px] [[readonly]]:cursor-not-allowed md:text-sm',
   {
      variants: {
         size: {
            sm: 'h-8 px-2.5 [&~[data-slot=autocomplete-clear]]:right-2 [&~[data-slot=autocomplete-trigger]]:right-2',
            default:
               'h-9 px-3 [&~[data-slot=autocomplete-clear]]:right-2.5 [&~[data-slot=autocomplete-trigger]]:right-2.5',
            lg: 'h-10 px-3 [&~[data-slot=autocomplete-clear]]:right-3 [&~[data-slot=autocomplete-trigger]]:right-3',
         },
      },
      defaultVariants: {
         size: 'default',
...
const AutocompleteClear = ({
   ...
   return (
      <button
         ...
         aria-label="Clear"
         className={cn(
            'ring-offset-background focus:ring-ring absolute top-1/2 -translate-y-1/2 cursor-pointer text-muted-foreground opacity-70 transition-opacity hover:opacity-100 focus:ring-0 focus:ring-offset-0 focus:outline-none disabled:pointer-events-none',
            className,
         )}
         {...props}
      >
...
const AutocompleteTrigger = ({
   ...
   return (
      <button
         ...
         className={cn(
            'focus:ring-ring ring-offset-background absolute top-1/2 -translate-y-1/2 cursor-pointer text-muted-foreground focus:ring-0 focus:ring-offset-0 focus:outline-none disabled:pointer-events-none has-[+[data-slot=autocomplete-clear]]:hidden',
            className,
         )}
         {...props}
      >
